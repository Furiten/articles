...
Если все игроки темпай или все игроки {{hint не являющиеся темпай}}нотен{{/hint}}, выплат по ничьей не производится.
...
Полный список яку можно посмотреть в {{link yaku-list.html}}одноименном разделе{{/link}}, здесь же мы ограничимся
...
за тем тайлом, который указан в индикаторе. Например, если в индикаторе 5 {{hint символов}}ман{{/hint}}, то шестерка ман будет дорой.
